    ...
    <div className='bg-gray-100'>
      ...
      <main className='lg:w-[65%] m-auto'>
        ...
        <div className='bg-white h-40 m-6 p-5 shadow-2xl shadow-gray-300'>
          ...
          <div className='flex'>
            <span className='text-[1.5px] mr-[4.5px] ml-[2px]'>1</span>
            <span className='text-[1.5px] mr-[4.5px]'>2</span>
            <span className='text-[1.5px] mr-[4.5px]'>3</span>
            <span className='text-[1.5px] mr-[4.5px]'>4</span>
            <span className='text-[1.5px] mr-[4.5px]'>5</span>
            <span className='text-[1.5px] mr-[4.5px]'>6</span>
            <span className='text-[1.5px] mr-[4.5px]'>7</span>
            <span className='text-[1.5px] mr-[4.5px]'>8</span>
            <span className='text-[1.5px] mr-[4.5px]'>9</span>
            <span className='text-[1.5px] mr-[4.5px]'>10</span>
            <span className='text-[1.5px] mr-[4.5px]'>11</span>
            <span className='text-[1.5px] mr-[4.5px]'>12</span>
            <span className='text-[1.5px] mr-[4.5px]'>13</span>
            <span className='text-[1.5px] mr-[4.5px]'>14</span>
            <span className='text-[1.5px] mr-[4.5px]'>15</span>
            <span className='text-[1.5px] mr-[4.5px]'>16</span>
            <span className='text-[1.5px] mr-[4.5px]'>17</span>
            <span className='text-[1.5px] mr-[4.5px]'>18</span>
            <span className='text-[1.5px] mr-[4.5px]'>19</span>
            <span className='text-[1.5px] mr-[4.5px]'>20</span>
            <span className='text-[1.5px] mr-[4.5px]'>21</span>
            <span className='text-[1.5px] mr-[4.5px]'>22</span>
            <span className='text-[1.5px] mr-[4.5px]'>23</span>
            <span className='text-[1.5px] mr-[4.5px]'>24</span>
            <span className='text-[1.5px] mr-[4.5px]'>25</span>
