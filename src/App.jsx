    ...
    <div className='bg-gray-100'>
      ...
      <main className='lg:w-[65%] m-auto'>
        ...
        <div className='bg-white h-40 m-6 p-5 shadow-2xl shadow-gray-300'>
          ...
          <div className='flex'>
            <span className='text-[2px] mr-[4px] ml-[2px]'>1</span>
            <span className='text-[2px] mr-[4px]'>2</span>
            <span className='text-[2px] mr-[4px]'>3</span>
            <span className='text-[2px] mr-[4px]'>4</span>
            <span className='text-[2px] mr-[4px]'>5</span>
            <span className='text-[2px] mr-[4px]'>6</span>
            <span className='text-[2px] mr-[4px]'>7</span>
            <span className='text-[2px] mr-[4px]'>8</span>
            <span className='text-[2px] mr-[4px]'>9</span>
            <span className='text-[2px] mr-[4px]'>10</span>
            <span className='text-[2px] mr-[4px]'>11</span>
            <span className='text-[2px] mr-[4px]'>12</span>
            <span className='text-[2px] mr-[4px]'>13</span>
            <span className='text-[2px] mr-[4px]'>14</span>
            <span className='text-[2px] mr-[4px]'>15</span>
            <span className='text-[2px] mr-[4px]'>16</span>
            <span className='text-[2px] mr-[4px]'>17</span>
            <span className='text-[2px] mr-[4px]'>18</span>
            <span className='text-[2px] mr-[4px]'>19</span>
            <span className='text-[2px] mr-[4px]'>20</span>
            <span className='text-[2px] mr-[4px]'>21</span>
            <span className='text-[2px] mr-[4px]'>22</span>
            <span className='text-[2px] mr-[4px]'>23</span>
            <span className='text-[2px] mr-[4px]'>24</span>
            <span className='text-[2px] mr-[4px]'>25</span>
